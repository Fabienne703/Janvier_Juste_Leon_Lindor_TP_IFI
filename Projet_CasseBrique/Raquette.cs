...
namespace Projet_CasseBrique
{
    ...
    public class Raquette : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            // ont été "enclenchés"
            if (DeplacementRaquette.CheckActionDroite())
            {
                if (!ElementText2D.testCollision(this, this.Balle.Bbox))
                {
            ...
            else if (DeplacementRaquette.CheckActionGauche())
            {
                if (!ElementText2D.testCollision(this, this.Balle.Bbox))
                {
